...
// Method provided by Rick DeNatale
// His blog on Ruby
...
function scrollToName(searcher_name){
	...
	if (!searcher_name.match(new RegExp(/\s+/))){ //if searcher name is blank
		...
		var searcher_pattern = new RegExp("^"+RegExp.escape(searcher_name.escapeHTML()), "i"); //the "i" is for case INsensitive - Using Ricks new method here
		// The old...soon to be deleted...
